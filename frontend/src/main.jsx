...
function App() {
  ...
  return (
    <BrowserRouter basename={basename}>
      <header style={{display:'flex',gap:12,padding:12,borderBottom:'1px solid #334155'}}>
        <b>Skynest</b>
...
function Bookings(){
  ...
  return (
    <div>
      ...
      <form onSubmit={e=>{e.preventDefault(); const fd=new FormData(e.currentTarget); const q=Object.fromEntries(Array.from(fd.entries()).filter(([,v])=>v)); setFilter(q); setPage(1); run(1)}} style={{display:'grid',gridTemplateColumns:'repeat(4, minmax(0,1fr))',gap:8,maxWidth:900}}>
      ...
      <section style={{border:"1px solid #334155",padding:12,borderRadius:8,marginTop:12}}>
  ...
  return (
    <div>
      ...
      <section style={{display:'grid',gridTemplateColumns:'repeat(2, minmax(0,1fr))',gap:12}}>
        <div style={{border:"1px solid #334155",padding:12,borderRadius:8}}>
        ...
        <div style={{border:"1px solid #334155",padding:12,borderRadius:8}}>
          ...
          <div style={{overflow:'auto'}}>
            <table style={{width:'100%',borderCollapse:'collapse'}}>
              ...
              <tbody>
                {rev.slice((p4-1)*pageSize, p4*pageSize).map((r,i)=> (
        ...
        <div style={{border:"1px solid #334155",padding:12,borderRadius:8}}>
          ...
          <div style={{overflow:'auto'}}>
            <table style={{width:'100%',borderCollapse:'collapse'}}>
              ...
              <tbody>
                {trend.slice(0,pageSize).map((r,i)=> (
