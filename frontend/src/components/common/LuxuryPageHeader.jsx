...
const LuxuryPageHeader = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl shadow-xl">
      ...
      />
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#1a237e]/90 to-[#0d47a1]/85" />
      {/* Dot Pattern */}
                ...
                {actions.map((a, idx) => (
                  <button
                    ...
                    className={
                      a.className ||
                      (a.variant === 'secondary'
                        ? 'px-4 py-2 rounded-xl bg-surface-secondary dark:bg-slate-800 text-white dark:text-slate-100 border border-border dark:border-slate-700 hover:bg-surface-tertiary dark:hover:bg-slate-700/40 shadow-sm flex items-center gap-2 transition-colors'
