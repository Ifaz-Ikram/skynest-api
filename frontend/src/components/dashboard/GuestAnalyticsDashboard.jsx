    ...
    <div className="bg-surface-secondary rounded-lg shadow-md p-6 border border-border">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4 text-center">
          ...
          <p className="text-xs text-text-secondary mt-1">Total Guests</p>
        </div>
        ...
        <div className="bg-green-50 rounded-lg p-4 text-center">
          ...
          <p className="text-xs text-text-secondary mt-1">Returning</p>
        </div>
        ...
        <div className="bg-purple-50 rounded-lg p-4 text-center">
          ...
          <p className="text-xs text-text-secondary mt-1">VIP Guests</p>
        </div>
        ...
        <div className="bg-orange-50 rounded-lg p-4 text-center">
          ...
          <p className="text-xs text-text-secondary mt-1">Avg. Stay (nights)</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        {/* Donut Chart */}
        <div>
          <h4 className="text-sm font-semibold text-text-secondary mb-3">Guest Type Distribution</h4>
          {guestTypeData.some(d => d.value > 0) ? (
            ...
            <p className="text-text-tertiary text-sm text-center py-8">No guest data available</p>
          )}
        </div>

        {/* Loyalty Metrics */}
        <div>
          <h4 className="text-sm font-semibold text-text-secondary mb-3">Loyalty Metrics</h4>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-text-secondary">New Guests</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-text-secondary">Returning Guests</span>
            ...
            <div className="pt-3 border-t border-border">
              <div className="flex items-center justify-between">
                <span className="text-sm text-text-secondary">Corporate Guests</span>
                <span className="text-lg font-bold text-indigo-600">{corporateGuests}</span>
              </div>
              <p className="text-xs text-text-tertiary mt-1">Business travelers and corporate bookings</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        {topNationalities.length > 0 ? (
            ...
            {topNationalities.map((nat, idx) => (
              <div key={idx} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-text-primary">{nat.country}</p>
                    <p className="text-xs text-text-tertiary">{nat.count} guest{nat.count !== 1 ? 's' : ''}</p>
                  </div>
                </div>
          ...
          <p className="text-text-tertiary text-sm text-center py-4">No nationality data available</p>
        )}
      </div>
